# Wendler 5/3/1 운동 기록 앱

> **5/3/1 앱에 돈 쓰지 마세요. 바이브 코딩으로 만들었습니다!**

오프라인 우선 Progressive Web App으로, **Wendler 5/3/1** 근력 훈련을 계획하고 기록합니다. 구독료 없이, 어두운 테마로 헬스장에서 바로 사용할 수 있도록 설계했습니다.

<p align="center">
  <img src="screenshots/03-dashboard.png" alt="대시보드" width="250" />
  <img src="screenshots/05-workout.png" alt="운동" width="250" />
  <img src="screenshots/07-settings.png" alt="설정" width="250" />
</p>

## 기능

### 핵심 운동
- **Wendler 5/3/1 주기화** -- 4주 사이클(5/5/5+, 3/3/3+, 5/3/1+, 디로드)
- **리더/앵커 구조** -- 리더와 앵커 사이클 수 설정
- **7th Week Protocol** -- 사이클 종료 후 테스트 또는 디로드
- **보조 운동** -- Boring But Big(5x10)과 First Set Last(5x5) 지원
...
- **데이터 내보내기/가져오기** -- JSON으로 훈련 데이터 백업
